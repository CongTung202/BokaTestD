...
<body>
    ...
    <section class="container my-3">
        ...
        <div class="card-body">
        <form action="{{route('ct.CreateSubmit')}}" method="POST">
        @csrf
        <div class="input-group input-group-sm mb-3">
        <span class="input-group-text" id="CTMAKHOA">Mã khoa</span>
        <input type="text" class="form-control" aria-describedby="MaKH"
        name="CTMAKHOA" value="">
        </div>
        <div class="input-group input-group-sm mb-3">
        <span class="input-group-text" id="CTMAKHOA">Tên khoa</span>
